...
<aui:script use="aui-base,aui-dialog-iframe,liferay-portlet-journal">
	...
	window.<portlet:namespace />journalPortlet = new Liferay.Portlet.Journal(Liferay.Portlet.Journal.PROXY.portletNamespace, '<%= (article != null) ? HtmlUtil.escapeURL(articleId) : StringPool.BLANK %>');
